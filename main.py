...
def main():    
    ...
    parser.add_argument('--command', default='predict', type=str, help='action to perform. {train, predict}.')
    parser.add_argument('--factor', default=2, type=int, help='training and testing stride factor of PD')
